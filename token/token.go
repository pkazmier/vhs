...
const (
	...
	CAPTION_AUDIO_VOLUME = "CAPTION_AUDIO_VOLUME"
...
var Keywords = map[string]Type{
	...
	"CaptionAudio":           CAPTION_AUDIO,
	"CaptionAudioVolume":     CAPTION_AUDIO_VOLUME,
	"Overlay":                OVERLAY,
...
func IsSetting(t Type) bool {
	...
	case SHELL, FONT_FAMILY, FONT_SIZE, LETTER_SPACING, LINE_HEIGHT,
		...
		AUDIO_VOLUME, CAPTION_AUDIO, CAPTION_AUDIO_VOLUME,
...
func IsCommand(t Type) bool {
	...
	case TYPE, SLEEP,
		...
		OVERLAY, AUDIO, CAPTION_ON, CAPTION_OFF:
		return true
	default:
		return false
	}
